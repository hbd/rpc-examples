...
// Defines the route with its request and response.
...
func (c *helloWorldProtobufClient) Hello(ctx context.Context, in *HelloReq) (*HelloResp, error) {
	ctx = ctxsetters.WithPackageName(ctx, "twitch.twirp.example.helloworld")
...
const HelloWorldPathPrefix = "/twirp/twitch.twirp.example.helloworld.HelloWorld/"
...
func (s *helloWorldServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	switch req.URL.Path {
	case "/twirp/twitch.twirp.example.helloworld.HelloWorld/Hello":
...
var twirpFileDescriptor0 = []byte{
	...
	0xc9, 0x2f, 0xcf, 0x2f, 0xca, 0x49, 0xd1, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x92, 0x2f, 0x29,
	0xcf, 0x2c, 0x49, 0xce, 0xd0, 0x2b, 0x29, 0xcf, 0x2c, 0x2a, 0xd0, 0x4b, 0xad, 0x48, 0xcc, 0x2d,
	0xc8, 0x49, 0xd5, 0x43, 0x28, 0x53, 0x52, 0xe1, 0xe2, 0xf0, 0x00, 0xf1, 0x82, 0x52, 0x0b, 0x85,
	...
	0x00, 0x00, 0xff, 0xff, 0x30, 0x55, 0xa3, 0x8d, 0xfe, 0x00, 0x00, 0x00,
}
